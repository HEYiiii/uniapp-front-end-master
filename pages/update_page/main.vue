    ...
    <div>
        <form>
            <view class="cu-form-group margin-top">
                ...
                <input v-model="productName" placeholder="请填写商品关键名称哦~" :name="goods.prodName"></input>
            </view>
            <view class="cu-form-group">
                <view class="title">价格</view>
                <input v-model="nowPrice" placeholder="请输入商品价格哦，例如9.99" :name="goods.nowPrice"></input>
            </view>
            <view class="cu-form-group">
                <view class="title">原价</view>
                <input v-model="prePrice" placeholder="可以输入商品原价格~" :name="goods.prePrice"></input>
            </view>
            <view class="cu-form-group">
                <view class="title">手机号</view>
                <input v-model="phoneNumber" placeholder="方便买家联系哦" :name="goods.subContact"></input>
            ...
            <view class="cu-form-group margin-top">
                <textarea v-model="productDescription" maxlength="-1" :disabled="modalName!=null"
                    @input="textareaAInput" placeholder="输入商品描述" :name="goods.prodDescription"></textarea>
            </view>
        </form>
